...
export const Info = () => {
  const skills = [
    ...
    {
      title: "Soft Skills",
      skills: ["Travail d'équipe", "Autonomie", "Curiosité", "Adaptabilité"],
    },
    {
      title: "Hobbies",
      skills: ["Jeux vidéos", "Animes/Mangas", "Programmation"],
    },
  ];

  return (
    <div
      className="p-10 flex justify-center mt-5 h-full overflow-auto sm:overflow-visible"
