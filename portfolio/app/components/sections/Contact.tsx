  ...
  return (
    <section id="contact" className="scroll-mt-24 max-w-5xl mx-auto px-6 pt-16 pb-28 md:pt-24 md:pb-40">
      <motion.div
        ...
        className="glass relative overflow-hidden rounded-3xl px-8 py-16 md:px-16 md:py-24 text-center"
      >
        <div
          aria-hidden="true"
        ...
        <div className="relative">
          ...
          <h2 className="text-3xl md:text-5xl font-semibold tracking-tight leading-tight text-balance mb-6">
          ...
          <a
            ...
            className="group inline-flex items-center gap-2 rounded-full bg-linear-to-r from-accent-strong to-fuchsia px-8 py-4 font-medium text-white shadow-[0_12px_45px_-10px] shadow-accent-strong/70 transition-shadow duration-300 hover:shadow-[0_16px_55px_-8px] hover:shadow-fuchsia/80"
          >
